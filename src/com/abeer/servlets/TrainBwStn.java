...
import com.abeer.beans.TrainBean;
import com.abeer.beans.TrainException;
import com.abeer.constant.UserRole;
import com.abeer.service.TrainService;
import com.abeer.service.impl.TrainServiceImpl;
import com.abeer.utility.TrainUtil;
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		try {
			...
			if (trains != null && !trains.isEmpty()) {
				...
				rd.include(req, res);
				pw.println("<div class='main'><p1 class='menu'>Book Ticket "
				...
				pw.println("<div class='tab'><table><tr><th>Train Name</th><th>Train No</th>"
						+ "<th>From Stn</th><th>To Stn</th><th>Time</th><th>Seats</th><th>Fare</th><th>Action</th></tr>");
